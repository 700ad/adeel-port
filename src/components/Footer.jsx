        ...
        <div className="footer__inner">
          <div className="relative h-screen text-orange-50">
            ...
            <div className="absolute top-0 right-0 text-white p-4 md:p-8">
              ...
              <Link to="https://adeel-adeelfarzand.zohobookings.com/#/customer/adeelfarzand" target="_blank" className="bg-black mt-2 py-2 wful text-white cursor-pointer dark:text-black dark:bg-white flex items-center justify-center text-3xl hover:bg-white/10 hover:dark:bg-black/10 w-full transition-all duration-300">
                Book Now
              </Link>
            </div>
