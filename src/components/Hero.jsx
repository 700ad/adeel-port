    ...
    <>
      <div id="cont" className="w-screen min-h-screen sunsts p-4 md:px-8 bg-white dark:bg-black text-black dark:text-white grid grid-cols-1 gap-4 md:gap-8 md:grid-cols-2 pt-16 md:pt-20">
        ...
        <div className="col-span-1 h-full items-center md:items-start justify-between pb-16 flex flex-col row-start-4 md:row-start-2">
          ...
          <div id="ball" className="w-20 mt-12 heroitem opacity-0 translate-y-3 rounded-full h-20">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" className="w-full h-full dark:stroke-white stroke-black">
