...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="col-span-1">
        <div className="w-full relative md:h-full h-40 bg-gradient-to-br from-transparent to-gray-900/80 dark:to-gray-200/80"></div>
      </div>
      <div className="col-span-1 h-full items-center md:items-start justify-between pb-16 flex flex-col row-start-4 md:row-start-2">
        <p className="lg:w-2/5 text-xl nord">
          Helping Companies Generate More Revenue By Creating Better Digital
          Products
        </p>
        <div id="ball" className="w-20 mt-12 rounded-full h-20">
          <svg
